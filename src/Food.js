          ...
          <ScrollView>
            <View style={{ flex: 1,backgroundColor:"#f2f2f2" }}>
              <View style={{width: width, alignItems:'center'}} >
                  <Image style={{height:60,width:width/2,margin:10 }} resizeMode="contain" source={require('./resource/image/foodapp.png')}/>
...
const styles = StyleSheet.create({
  ...
  divFood: {
    ...
    padding : 10,
    borderRadius: 10,
    marginTop: 55,//Espacio entre pares imagenes horizontales
    marginBottom: 5,
    marginLeft: 10 ,
    alignItems: 'center',
    elevation:8, //sombra
